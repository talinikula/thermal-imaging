...
The data is recorded locally on UAV and streamed for monitoring purposed to ground station.

![The live data streaming to groud station](monitor.jpg "The live data streaming to groud statio")
